...
FIX: Speichert jetzt ALLE Metriken (Precision, Recall) für den Vergleich.
"""
...
print("=" * 70)
print("BASELINE MODEL: Logistic Regression (With Precision/Recall)")
print("=" * 70)
...
exclude_cols = [
    ...
    'm2_close', 'm2_open', 'm2_high', 'm2_low', 'm2_value',
...
def evaluate(model, X, y, name):
    ...
    # WICHTIG: Dictionary zurückgeben
    return {
        'accuracy': acc,
        'precision': precision,
        'recall': recall,
